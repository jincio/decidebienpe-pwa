  ...
  <v-container>
    <v-layout row>
      <v-flex md4>
        <v-card class="mb-2 mx-2" shaped raised>
          <v-list-item three-line>
            <v-list-item-content>
              ...
              <ul>
                <li>
                  Cuando abres la página todos los filtros están inactivos
                </li>
        ...
        <v-card class="pa-2 mb-2 mx-2" raised shaped="">
          <v-select
            :items="regiones"
            item-text="region"
            item-value="codigo"
      ...
      <v-flex md8>
        <v-card class="pa-2 mx-2" raised shaped>
          <span v-if="defaultSelected"
            ><p>
              {{ showRegion }}, número de escaños ({{ showCurules }}).
            </p></span
          >
          <p>
...
export default {
  ...
  methods: {
    updateQuery() {
      if (
        ...
        this.$router.push({
          name: "filtros",
          params: {
            departamento: this.regiones[this.defaultSelected - 1].region
          },
          query: {
    ...
    selectValidDepartamento() {
      ...
      if (urlDepto) {
        ...
        if (newDefault[0].region) {
          this.defaultSelected = newDefault[0].codigo;
    ...
    changeRoute(a) {
      this.$router.push({
        name: "filtros",
        params: { departamento: this.regiones[a - 1].region },
        query: {
          checkbox1: this.checkbox1,
          checkbox2: this.checkbox2,
          checkbox3: this.checkbox3,
